...
function App() {
  ...
  const [rules, setRules] = useState([
    ...
    { onColor: "#000000", nextColor: "#37d67a", rotation: "l2", numSteps: 1 },
    { onColor: "#37d67a", nextColor: "#ff8a65", rotation: "n", numSteps: 1 },
    { onColor: "#ff8a65", nextColor: "#1f28cd", rotation: "u", numSteps: 1 },
    { onColor: "#1f28cd", nextColor: "#f59e06", rotation: "l2", numSteps: 1 },
    { onColor: "#f59e06", nextColor: "#436bc3", rotation: "l", numSteps: 1 },
    { onColor: "#436bc3", nextColor: "#ffffff", rotation: "r2", numSteps: 1 }
  ]);
